...
(cl:defmethod cl:initialize-instance :after ((m <value>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'value)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name materi_3-msg:<value> is deprecated: use materi_3-msg:value instead.")))

(cl:ensure-generic-function 'hue_max-val :lambda-list '(m))
(cl:defmethod hue_max-val ((m <value>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader materi_3-msg:hue_max-val is deprecated.  Use materi_3-msg:hue_max instead.")
  (hue_max m))

(cl:ensure-generic-function 'hue_min-val :lambda-list '(m))
(cl:defmethod hue_min-val ((m <value>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader materi_3-msg:hue_min-val is deprecated.  Use materi_3-msg:hue_min instead.")
  (hue_min m))

(cl:ensure-generic-function 'saturation_max-val :lambda-list '(m))
(cl:defmethod saturation_max-val ((m <value>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader materi_3-msg:saturation_max-val is deprecated.  Use materi_3-msg:saturation_max instead.")
  (saturation_max m))

(cl:ensure-generic-function 'saturation_min-val :lambda-list '(m))
(cl:defmethod saturation_min-val ((m <value>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader materi_3-msg:saturation_min-val is deprecated.  Use materi_3-msg:saturation_min instead.")
  (saturation_min m))

(cl:ensure-generic-function 'value_max-val :lambda-list '(m))
(cl:defmethod value_max-val ((m <value>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader materi_3-msg:value_max-val is deprecated.  Use materi_3-msg:value_max instead.")
  (value_max m))

(cl:ensure-generic-function 'value_min-val :lambda-list '(m))
(cl:defmethod value_min-val ((m <value>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader materi_3-msg:value_min-val is deprecated.  Use materi_3-msg:value_min instead.")
  (value_min m))
